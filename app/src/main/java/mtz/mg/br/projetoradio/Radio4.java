...
public class Radio4 extends AppCompatActivity implements MediaPlayer.OnPreparedListener,MediaPlayer.OnSeekCompleteListener,MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnErrorListener {
    ...
    final String urlRock4 = "http://192.99.62.212:9408/metalrockfm";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.radio4);
    ...
    public void onPrevious(View view){
        ...
        Vibrator vibe = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE) ;
        vibe.vibrate(30);
        startActivity(new Intent(this, Radio3.class));
        finish();
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                            ...
                            synchronized (this) {
                                try {
                                    ...
                                    try {
                                        ...
                                        meta.setStreamUrl(new URL("" + urlRock4));
                                        title = meta.getStreamTitle();
...
// */
        ...
        dialog = new ProgressDialog(Radio4.this);
