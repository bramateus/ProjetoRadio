...
public class Radio2 extends AppCompatActivity implements MediaPlayer.OnPreparedListener,MediaPlayer.OnSeekCompleteListener,MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnErrorListener {
    ...
    final String urlRock2 = "http://188.40.32.140:8242/poprockdobrasil";
                            ...
                            synchronized (this) {
                                try {
                                    ...
                                    try {
                                        ...
                                        meta.setStreamUrl(new URL("" + urlRock2));
                                        title = meta.getStreamTitle();
...
// */
        ...
        dialog = new ProgressDialog(Radio2.this);
