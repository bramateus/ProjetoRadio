...
public class Radio5 extends AppCompatActivity implements MediaPlayer.OnPreparedListener,MediaPlayer.OnSeekCompleteListener,MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnErrorListener {
    ...
    final String urlRock5 = "http://hestia2.cdnstream.com/1369_128";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.radio5);
    ...
    public void onPrevious(View view){
        ...
        Vibrator vibe = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE) ;
        vibe.vibrate(30);
        startActivity(new Intent(this, Radio4.class));
        finish();
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                            ...
                            synchronized (this) {
                                try {
                                    ...
                                    try {
                                        ...
                                        meta.setStreamUrl(new URL("" + urlRock5));
                                        title = meta.getStreamTitle();
...
// */
        ...
        dialog = new ProgressDialog(Radio5.this);
