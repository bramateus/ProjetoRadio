...
public class Radio7 extends AppCompatActivity implements MediaPlayer.OnPreparedListener,MediaPlayer.OnSeekCompleteListener,MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnErrorListener {
    ...
    final String urlRock7 = "http://online-radioroks2.tavrmedia.ua/RadioROKS_ACDC";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.radio7);
    ...
    public void onNext(View view){
        ...
        vibe.vibrate(30);
        startActivity(new Intent(this, Radio8.class));
        finish();
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
    }
    ...
    public void onPrevious(View view){
        ...
        Vibrator vibe = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE) ;
        vibe.vibrate(30);
        startActivity(new Intent(this, Radio6.class));
        finish();
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                            ...
                            synchronized (this) {
                                try {
                                    ...
                                    try {
                                        ...
                                        meta.setStreamUrl(new URL("" + urlRock7));
                                        title = meta.getStreamTitle();
...
// */
        ...
        dialog = new ProgressDialog(Radio7.this);
