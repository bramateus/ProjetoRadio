...
public class MainActivity extends AppCompatActivity implements MediaPlayer.OnPreparedListener,MediaPlayer.OnSeekCompleteListener,MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnErrorListener {
    ...
    final String urlRock = "http://14003.live.streamtheworld.com:3690/RADIOCIDADE_SC";
                                            ...
                                            synchronized (this) {
                                                try {
                                                    ...
                                                    try {
                                                        ...
                                                        meta.setStreamUrl(new URL("" + urlRock));
                                                        title = meta.getStreamTitle();
