...
public class Radio3 extends AppCompatActivity implements MediaPlayer.OnPreparedListener,MediaPlayer.OnSeekCompleteListener,MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnErrorListener {
    ...
    final String urlRock3 = "http://10433.live.streamtheworld.com:443/CIDADEROCKBRASILAAC_SC";
    ...
    public void onPrevious(View view){
        ...
        Vibrator vibe = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE) ;
        vibe.vibrate(30);
        startActivity(new Intent(this, Radio2.class));
        finish();
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                            ...
                            synchronized (this) {
                                try {
                                    ...
                                    try {
                                        ...
                                        meta.setStreamUrl(new URL("" + urlRock3));
                                        title = meta.getStreamTitle();
...
// */
        ...
        dialog = new ProgressDialog(Radio3.this);
